...
namespace Carfup.XTBPlugins.QueryConverter
{
    [Export(typeof(IXrmToolBoxPlugin)),
       ExportMetadata("Name", "QueryConverter"),
       ExportMetadata("Description", "QueryConverter allows you to convert any query : from and to QueryExpression, FetchXml, WebApi and LinQ"),
